...
import { Badge, EmptyState, Stars } from "./ui";
import type { Venue } from "../lib/types";

/** Searchable catalog of training venues, shared by the org and provider consoles. */
export function VenueBrowser({
  ...
  useEffect(() => {
    api
      .get<{ venues: Venue[]; types: string[]; locations: string[] }>(endpoint)
